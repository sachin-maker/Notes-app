...
import com.sachin.mynotesapp.Note.AddNote;
import com.sachin.mynotesapp.Note.EditNote;
import com.sachin.mynotesapp.Note.NoteDetails;
import com.sachin.mynotesapp.auth.Login;
import com.sachin.mynotesapp.auth.Register;
import com.sachin.mynotesapp.model.Note;
        ...
        switch(item.getItemId()){
            ...
            case R.id.shareapp:
                try {
                    ...
                    shareIntent.putExtra(Intent.EXTRA_TEXT, "I'm using this Free Notebook App, You cant Note Everythings  https://play.google.com/store/apps/details?id=" + getApplicationContext().getPackageName());
                    startActivity(Intent.createChooser(shareIntent, "choose one"));
                } catch (Exception e) {
                }
                break;
            case R.id.privacy_policy:
                Intent intent_policy = new Intent(MainActivity.this,PrivacyPolicyActivity.class);
